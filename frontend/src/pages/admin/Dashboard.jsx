...
export default function AdminDashboard() {
  ...
  const resumo = useMemo(() => {
    ...
    const confirmadas = formacoesRecentes.filter(
  ...
  const cards = [
    {
      icon: '👥',
      valor: stats.total_participantes || 0,
      label: 'Participantes Ativos',
      detalhe: 'Usuários disponíveis para inscrição',
      cor: 'laranja',
      to: '/admin/usuarios'
    },
    {
      ...
      label: 'Formações Cadastradas',
      detalhe: `${resumo.abertas} abertas recentemente`,
      cor: 'verde',
      to: '/admin/formacoes'
    },
    {
      ...
      detalhe: 'Participações registradas no sistema',
      cor: 'amarelo',
      to: '/admin/inscricoes'
    },
    {
      ...
      detalhe: 'Documentos liberados aos participantes',
      cor: 'laranja',
  ...
  detalhe: `${stats.itensBibliotecaMes || 0} adicionados este mês`,
  cor: 'verde',
        ...
        <div className="dashboard-header">
          <div>
            ...
            <p className="dashboard-subtitulo">
              Resumo administrativo do sistema •{' '}
          ...
          <div className="dashboard-header-acoes">
            <Link to="/admin/relatorios" className="btn btn-outline">
              📈 Relatórios
            </Link>

            <Link to="/admin/formacoes" className="btn btn-primario">
              + Nova Formação
            </Link>
          </div>
        </div>
        ...
        <div className="dashboard-grid-principal">
          <div className="card dashboard-card-sombra">
            <div className="card-titulo">
              ...
              <Link to="/admin/formacoes" className="link-card">
                Ver todas →
              </Link>
            </div>
                    ...
                    {formacoesRecentes.map(f => {
                      ...
                      return (
                        <tr key={f.id}>
                          ...
                          <td>
                            <Link
                              to={`/admin/formacoes?editar=${f.id}`}
  ...
  {[
    ['/admin/formacoes', '📚 Nova Formação', 'btn-primario'],
    ['/admin/usuarios', '👥 Gerenciar Participantes', 'btn-secundario'],
    ['/admin/biblioteca-painel', '📖 Painel da Biblioteca', 'btn-outline'],
    ['/admin/inscricoes', '📋 Acompanhar Inscrições', 'btn-outline'],
    ['/admin/frequencia', '✅ Registrar Frequência', 'btn-outline'],
    ['/admin/certificados', '🎓 Emitir Certificados', 'btn-outline'],
    ['/admin/relatorios', '📈 Ver Relatórios', 'btn-outline'],
    ['/admin/logs', '🗒️ Logs de Atividades', 'btn-outline']
  ].map(([to, label, cls]) => (
