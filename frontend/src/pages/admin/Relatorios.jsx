...
export default function AdminRelatorios() {
  ...
  const podeExportar = user?.tipo === 'admin' || user?.tipo === 'coordenador';
  ...
  async function exportarPDF() {
    ...
    try {
      ...
      pdf.save(`relatorio_${timestampArquivo()}.pdf`);
    } catch (err) {
          ...
          <div className="stats-grid mb-24">
            {[
              ...
              <div key={c.label} className="stat-card animar-entrada">
                ...
                <div>
                  <div className="stat-valor">{c.valor || 0}</div>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                        className="acesso-regiao-numero"
                        style={{
                        fontWeight: 800,
                        color: 'var(--laranja)',
                        whiteSpace: 'nowrap'
